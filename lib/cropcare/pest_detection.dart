...
import 'package:communityapp/cropcare/pest_result.dart';
...
class PestDetection extends StatefulWidget {
  const PestDetection({Key? key}) : super(key: key);
...
class _PestDetectionState extends State<PestDetection> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
          child: (_futureAlbum == null) ? pestPage() : buildFutureBuilder(),
        ));
  }

  SingleChildScrollView pestPage() {
              ...
              children: [
                ...
                if (image == null) ...[
                  ...
                  MaterialButton(
                      ...
                      onPressed: () {
                        setState(() {
                          _futureAlbum = onUploadImage(File(image!.path));
                        });
                      }),
                ],
              ],
