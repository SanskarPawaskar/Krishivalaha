...
class DiseasePredictionResult extends StatefulWidget {
  final dynamic snapshot;
  const DiseasePredictionResult(this.snapshot,{Key? key}) : super(key: key);

  @override
  State<DiseasePredictionResult> createState() => _DiseasePredictionResultState();
}

class _DiseasePredictionResultState extends State<DiseasePredictionResult> {
...
//             children: <Widget>[
//              Text('${widget.snapshot.data['Prediction']}'),
